...
def create_facebook_event(event):
    ...
    more = driver.find_element_by_xpath(
        "/html/body/div[1]/div[3]/div[1]/div/div[2]/div[2]/div[2]/div[2]/div[2]/div[2]/div/div/div[2]/div[1]/div/div/div/div[1]/div/div[1]/div/ul/li[4]/div/a"
    )
    more.click()

    create_event = driver.find_element_by_css_selector(
        ".fbReactComposerAttachmentSelector_EVENT > span:nth-child(1) > span:nth-child(2)"
    )
    create_event.click()
    """
