...
async def on_message(message):
    ...
    if client.user.mentioned_in(message):
        ...
        if event:
            ...
            await client.send_message(
                message.channel,
                content="Certainly {}, Our Upcoming events are \n {}".format(
                    name, upcoming
                ),
            )
        else:
            await client.send_message(
                message.channel,
                content="Hey {}, I'm Sarah, VP of marketing operations here at Bots Unlimited. I don't check Discord often, so if you want to talk to me, please mention me. You can ask me about what events are coming up".format(
                    name
                ),
            )


client = wrap_bot(on_message)
